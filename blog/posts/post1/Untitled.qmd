---
title: "My First Blog Post: Understanding Logit"
date: 2026-09-14
categories:
  - Econometrics
  - Microeconomics
...
In economics and data science, we often want to predict the probability of an event. For example, we may want to estimate the probability that a person votes for a certain political party, buys a product, or chooses one transportation option over another.
